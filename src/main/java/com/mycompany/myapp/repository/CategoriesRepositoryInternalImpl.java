...
/**
 * Spring Data R2DBC custom repository implementation for the Categories entity.
 */
@SuppressWarnings("unused")
class CategoriesRepositoryInternalImpl extends SimpleR2dbcRepository<Categories, Long> implements CategoriesRepositoryInternal {
    ...
    @Override
    public Mono<Categories> findById(Long id) {
