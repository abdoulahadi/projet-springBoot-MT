...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './clients.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLIENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLIENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLIENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLIENTS actions', async () => {
      const expectedActions = [
        {
