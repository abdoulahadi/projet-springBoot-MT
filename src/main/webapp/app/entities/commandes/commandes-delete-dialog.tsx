...
import { getEntity, deleteEntity } from './commandes.reducer';

export const CommandesDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(commandesEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-commandes" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
...
export default CommandesDeleteDialog;
