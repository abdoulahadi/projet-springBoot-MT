...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './commandes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMANDES_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMMANDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMMANDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMMANDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMMANDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMMANDES actions', async () => {
      const expectedActions = [
        {
